...
/**
 * Fixed bottom action bar. Spec §9.1: always present below 1024px from first paint,
 * both halves filled, WhatsApp absorbed as a third segment. Hidden at 1024px and above
 * by `.action-bar` itself.
 */
export function ActionBar() {
  ...
  return (
    <nav className="action-bar" aria-label="Quick actions">
      <a href={site.phoneHref} className="act-call" aria-label={`Call ${site.name}`}>
        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
          <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z" />
        </svg>
        Call
      </a>
      <Link to={bookTo} className="act-book" aria-label={bookLabel}>
        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
      ...
      {wa && (
        <a href={`https://wa.me/${wa}`} target="_blank" rel="noopener noreferrer" className="act-chat"
